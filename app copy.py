...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("quantiq_analysis.log"),  # Save logs to a file
...
def add_style(html_content):
    ...
    try:
        ...
        logging.debug(f"Parsed HTML content: {html_content}...")
...
def quantiq_analysis(client, filename, input_dir=None):
    ...
    try:
        ...
        logging.debug(f"Received message content: {message_content[:100]}...")
        ...
        if st.button(button_label, type="primary"):
            ...
            with st.spinner("Analyzing..."):
                for idx, filename in enumerate(files_to_process):
                    ...
                    oai_file_mgr(client, show=False, delete_vsf=False,
                                 delete_vss=True, delete_files=True)
            st.success('Done!')
